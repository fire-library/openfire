    ...
    vec![
        ...
        DocumentImplementations {
            ...
            implementations: vec![
                ...
                cibse_guide_e::chapter_7::equation_7_7::openfire_runner::Chapter7Equation7Runner.index_page(),
                cibse_guide_e::chapter_7::equation_7_8::openfire_runner::Chapter7Equation8Runner.index_page(),
                cibse_guide_e::chapter_7::equation_7_9::openfire_runner::Chapter7Equation9Runner.index_page(),
...
pub fn register_runners() {
    ...
    >();
    framework::register_runner::<
        cibse_guide_e::chapter_7::equation_7_7::openfire_runner::Chapter7Equation7Runner,
    >();
    framework::register_runner::<
        cibse_guide_e::chapter_7::equation_7_8::openfire_runner::Chapter7Equation8Runner,
    >();
    framework::register_runner::<
        cibse_guide_e::chapter_7::equation_7_9::openfire_runner::Chapter7Equation9Runner,
    >();
    framework::register_runner::<
