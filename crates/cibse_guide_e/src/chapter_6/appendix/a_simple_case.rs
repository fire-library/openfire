...
pub fn internal_surface_area(a_f: f64, h: f64, w1: f64, w2: f64, a_o: f64) -> f64 {
    return 2 * a_f + 2 * h * (w1 + w2) - a_o;
}

pub fn equation_internal_surface_area(a_net: String, a_f: String, h: String, w1: String, w2: String, a_o: String) -> String {
    format!("{} = 2 \\cdot {} + 2 \\cdot {} ({} + {}) - {}", a_net, a_f, h, w1, w2, a_o);
}
...
pub fn equation_ratio_depth_over_height(d: String, w: String, w1: String, w2: String) -> String {
    format!("{} / {} = {} / {}", d, w, w2, w1);
}
