...
pub fn equation_equivalent_width_of_openings(w_o: String, widths_of_openings: Vec<String>) -> String {
    let formatted_widths = widths_of_openings.join(" + ");
    format!("{} = {}", w_o, formatted_widths)
}

pub fn equivalent_height_of_openings(equivalent_area_of_openings: f64, equivalent_width_of_openings: f64) -> f64 {
...
pub fn equation_equivalent_height_of_openings(h_o: String, a_o: String, w_o: String) -> String {
    format!("{} = {} / {}", h_o, a_o, w_o)
}
