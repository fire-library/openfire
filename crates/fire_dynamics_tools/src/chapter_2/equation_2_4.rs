...
pub fn thermal_penetration_time_equation(t_p: String, rho: String, c_p: String, k: String, delta: String) -> String {
    format!("{} = \\frac{{{} \\cdot {}}}{{{}}} \\cdot \\left( \\frac{{{}}}{2} \\right)^2}}", t_p, c_p, rho, k, delta)
}
