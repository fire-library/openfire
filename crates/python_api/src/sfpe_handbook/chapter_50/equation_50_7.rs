...
#[pyfunction]
/// This function calculates the pressure exerted by wind on a building's wall surface (Equation 50-7).
///
/// .. math::
///
...
/// Example:
///     >>> import ofire
///     >>> result = ofire.sfpe_handbook.chapter_50.equation_50_7.wind_pressure(0.8, 1.2, 15.0)
///     >>> print(f"{result:.2f} Pa")
fn wind_pressure(c_w: f64, rho_0: f64, u_h: f64) -> PyResult<f64> {
    Ok(rust_equation_50_7::wind_pressure(c_w, rho_0, u_h))
}
